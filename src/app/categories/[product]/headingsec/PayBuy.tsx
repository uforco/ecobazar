        ...
        <div className="flex w-full items-center gap-5 my-5 border-b pb-5  " >
            <div className=" flex items-center gap-2 ">
              <div className=" flex gap-4 items-center rounded-full border p-2  " >
                ...
                <button onClick={()=> setQty((privous) => privous < 20? privous+1 : privous ) } className=" bg-gray-300 text-gray-600 w-8 h-8 flex justify-center items-center rounded-full " >+</button>
              </div>
            </div>
            <div className=" flex items-center gap-2  w-full " >
              <button className=" bg-Primary text-white w-full h-12  rounded-full flex justify-center items-center " >
                Add to Cart
